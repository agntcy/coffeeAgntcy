...
def langchain_to_copilotkit(messages: List[BaseMessage]) -> List[Dict[str, Any]]:
    """
    Convert LangChain messages to CopilotKit format.

    The CopilotKit format splits tool calls into separate messages and maintains
