...
**Step 5: Visualize OTEL Traces in Grafana(Todo- add screenshots when app-sdk provides a way to enable observability)**
...
4. **View Traces for the Corto Multi-Agent System**  
   ...
   ![Screenshot: OTEL Dashboard](images/otel_dashboard_placeholder.png)
