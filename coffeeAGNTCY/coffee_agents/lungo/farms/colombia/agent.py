...
class FarmAgent:
    def __init__(self):
        yield_agent = create_react_agent(
            ...
            tools = [],
            prompt=(
                "You are a helpful coffee farm cultivation manager in Colombia.\n"
        ...
        orders_agent = create_react_agent(
            ...
            tools = [],
            prompt=(
                "You are a helpful coffee farm orders manager in Colombia.\n"
        ...
        graph = create_supervisor(
            ...
            prompt = (
                "You are a coffee farm manager in Colombia.\n"
