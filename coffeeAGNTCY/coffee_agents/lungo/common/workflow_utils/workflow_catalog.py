...
Workflow identity (workflow_name + instance_id) is propagated via
OpenTelemetry baggage (see ``common.workflow_context_prop``).
This module resolves a propagated workflow_name to catalog metadata.
"""
