...
AGENT_CARD = AgentCard(
    ...
    additional_interfaces=[
        ...
        AgentInterface(transport="slimrpc", url=f"slim://{SLIM_SERVER}/lungo/agents/brazil_coffee_farm"),
        # slim-based group comm and pub/sub transport
        AgentInterface(transport="slim", url=f"slim://{SLIM_SERVER}/lungo/agents/brazil_coffee_farm"),
        # nats-based pub/sub transport for broadcasting to multiple subscriber
        AgentInterface(transport="nats", url=f"nats://{NATS_SERVER}/lungo/agents/brazil_coffee_farm"),
