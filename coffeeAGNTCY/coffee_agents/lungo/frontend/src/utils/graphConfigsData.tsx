  ...
  nodes: [
    ...
    },
    {
      ...
      data: {
        icon: CoffeeBeanIcon,
        label: "Brazil",
        label_subtitle: "Coffee Farm Agent",
  ...
  nodes: [
    ...
    },
    {
      ...
      data: {
        icon: SupervisorIcon,
        label: "Buyer",
        label_subtitle: "Logistics Agent",
        handles: HANDLE_TYPES.SOURCE,
    ...
    },
    {
      ...
      data: {
        icon: <Calculate />,
        label: "Accountant",
        label_subtitle: "Accountant Agent",
        handles: HANDLE_TYPES.TARGET,
  ...
  nodes: [
    ...
    },
    {
      ...
      data: {
        ...
        label: "Directory",
        label_subtitle: "AGNTCY Agent Directory",
        handles: HANDLE_TYPES.ALL,
