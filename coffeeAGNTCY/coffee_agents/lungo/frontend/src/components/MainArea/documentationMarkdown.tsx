...
export const DOCUMENTATION_MARKDOWN_COMPONENTS: Components = {
  ...
  h6: ({ children, ...props }) => (
    <h6
      className="text-sidebar-text/95 mb-1.5 mt-3 text-sm font-semibold first:mt-0"
      {...props}
    >
      {children}
    </h6>
  ...
  p: ({ children, ...props }) => (
    <p
      className="text-sidebar-text/95 mb-3 text-[15px] leading-relaxed last:mb-0"
      {...props}
    >
      {children}
    </p>
  ...
  ul: ({ children, ...props }) => (
    <ul
      className="text-sidebar-text/95 mb-3 list-disc space-y-1.5 pl-5 text-[15px] leading-relaxed marker:text-accent-primary"
      {...props}
    >
      {children}
    </ul>
  ...
  ol: ({ children, ...props }) => (
    <ol
      className="text-sidebar-text/95 mb-3 list-decimal space-y-1.5 pl-5 text-[15px] leading-relaxed marker:font-medium marker:text-accent-primary"
      {...props}
    >
      {children}
    </ol>
  ...
  li: ({ children, ...props }) => (
    <li className="pl-0.5 [&>p:last-child]:mb-0 [&>p]:mb-2" {...props}>
      {children}
    </li>
  ),
  ...
  em: ({ children, ...props }) => (
    <em className="text-sidebar-text/95 italic" {...props}>
      {children}
    </em>
  ),
  a: ({ children, ...props }) => (
  ...
  blockquote: ({ children, ...props }) => (
    <blockquote
      className="text-sidebar-text/90 mb-3 border-l-4 border-accent-primary py-0.5 pl-3 text-[15px] italic"
      {...props}
    >
      {children}
    </blockquote>
  ...
  table: ({ children, ...props }) => (
    <div className="mb-3 w-full overflow-x-auto">
      <table
        className="text-sidebar-text/95 w-full min-w-[16rem] border-collapse text-left text-[14px]"
        {...props}
      >
        {children}
      </table>
  ...
  thead: ({ children, ...props }) => (
    <thead
      className="bg-node-background/80 border-b border-sidebar-border"
      {...props}
    >
      {children}
    </thead>
  ...
  th: ({ children, ...props }) => (
    <th
      className="border border-sidebar-border px-2 py-1.5 font-semibold"
      {...props}
    >
      {children}
    </th>
  ...
  td: ({ children, ...props }) => (
    <td
      className="border border-sidebar-border px-2 py-1.5 align-top"
      {...props}
    >
      {children}
    </td>
